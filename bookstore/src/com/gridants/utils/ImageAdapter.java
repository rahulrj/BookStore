...
public class ImageAdapter extends BaseAdapter {
	...
	public ImageAdapter(Context context, String[] titlearray,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			URL url = null;
			try {
				url = new URL("http://crossword.gridants.webfactional.com/photos/"+(imageid[position].substring(2)));
			} catch (MalformedURLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			
			Log.d("the wanted url",url.toString());
			Bitmap bmp = null;
			try {
